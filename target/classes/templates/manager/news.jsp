    ...
    <div id="xt-right">
        ...
        <div class="xt-fenye">
            ...
            <div class="xt-fenye-right">
                <a href="http://localhost:8080/manager/news.jsp?page=1">首页</a>
                <a href="http://localhost:8080/manager/news.jsp?page=1">上一步</a>
                <a href="http://localhost:8080/manager/news.jsp?page=1">下一步</a>
                <a href="http://localhost:8080/manager/news.jsp?page=1">尾页</a>
                <input type="text" name="text" />
                <a href="http://localhost:8080/manager/news.jsp?page=1" class="xt-link">跳转</a>
            </div>
        </div>
        <%}else{%>
        <div class="xt-table">
            <table cellpadding="0" cellspacing="0" border="0" bgcolor="#dcdcdc" width="100%">
                ...
                %>
                     <tr class="xt-bg">
                         ...
                         <td><a href="javascript:void (0);" onclick="getnbyid(<%=notice.getNoticeid()%>);" class="yellow-xt">详情</a></td>
                     </tr>
                <%}%>
            </table>
        </div>
        ...
        <div class="xt-fenye">
            ...
            <div class="xt-fenye-right">
                ...
                <a href="http://localhost:8080/manager/news.jsp?page=<%if(p==1){%><%=1%><%}else{%><%=p-1%><%}%>">上一步</a>
...
<script type="text/javascript">
    function next(){
        window.location.href="http://localhost:8080/manager/news.jsp?page=<%if(p>=totalpages){%><%=totalpages%><%}else{%><%=p+1%><%}%>";
    }
</script>
<script type="text/javascript">
    function jump(){
        ...
        window.location.href="http://localhost:8080/manager/news.jsp?page="+jumpto;
    }
</script>
<% }%>
